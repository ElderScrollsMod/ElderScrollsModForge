...
public class CenturySoupItem extends Item {
	public CenturySoupItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A78Served for the return of Queen Ayreen. Often eaten with bread."));
	}
}
