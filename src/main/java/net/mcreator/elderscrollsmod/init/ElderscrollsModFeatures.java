...
import net.mcreator.elderscrollsmod.world.features.plants.NirnrootFeature;
...
public class ElderscrollsModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(NirnrootFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.VEGETAL_DECORATION, NirnrootFeature.GENERATE_BIOMES,
				NirnrootFeature.CONFIGURED_FEATURE));
	}
