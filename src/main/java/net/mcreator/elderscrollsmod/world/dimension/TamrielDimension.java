...
public class TamrielDimension {
	...
	public static class Fixers {
		...
		public static void registerFillerBlocks(FMLCommonSetupEvent event) {
			...
			replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("river")).getGenerationSettings().getSurfaceBuilder().get()
					.config().getUnderMaterial().getBlock());
			replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("elderscrolls:auridon_biome")).getGenerationSettings()
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("elderscrolls:tamriel"), customEffect));
		}
	}
}
