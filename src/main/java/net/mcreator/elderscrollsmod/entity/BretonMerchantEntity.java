...
public class BretonMerchantEntity extends ElderScrollsModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("breton_merchant").setRegistryName("breton_merchant");

	public BretonMerchantEntity(ElderScrollsModModElements instance) {
		super(instance, 27);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BretonMerchantRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends VillagerEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			setCustomName(new StringTextComponent("Breton Merchant"));
