...
public class NirnrootBlock extends ElderScrollsModModElements.ModElement {
	@ObjectHolder("elder_scrolls_mod:nirnroot")
	public static final Block block = null;

	public NirnrootBlock(ElderScrollsModModElements instance) {
		super(instance, 2);
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new DefaultFlowersFeature(BlockClusterFeatureConfig.field_236587_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
					...
					if (dimensionType == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("elder_scrolls_mod:tamriel")))
			...
			event.getRegistry().register(feature.setRegistryName("nirnroot"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("elder_scrolls_mod:nirnroot"), configuredFeature);
		}
	}
