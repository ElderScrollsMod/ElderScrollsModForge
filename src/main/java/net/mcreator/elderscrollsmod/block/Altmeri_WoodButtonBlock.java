...
public class Altmeri_WoodButtonBlock extends ElderScrollsModModElements.ModElement {
	@ObjectHolder("elder_scrolls_mod:altmeri_wood_button")
	public static final Block block = null;

	public Altmeri_WoodButtonBlock(ElderScrollsModModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("altmeri_wood_button");
		}
