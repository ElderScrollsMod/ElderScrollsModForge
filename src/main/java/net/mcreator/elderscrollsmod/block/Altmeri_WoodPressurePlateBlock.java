...
public class Altmeri_WoodPressurePlateBlock extends ElderScrollsModModElements.ModElement {
	@ObjectHolder("elder_scrolls_mod:altmeri_wood_pressure_plate")
	public static final Block block = null;

	public Altmeri_WoodPressurePlateBlock(ElderScrollsModModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("altmeri_wood_pressure_plate");
		}
