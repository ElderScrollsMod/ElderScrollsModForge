...
public class Altmeri_WoodSlabBlock extends ElderScrollsModModElements.ModElement {
	@ObjectHolder("elder_scrolls_mod:altmeri_wood_slab")
	public static final Block block = null;

	public Altmeri_WoodSlabBlock(ElderScrollsModModElements instance) {
		super(instance, 11);
	}
