...
public class Altmeri_WoodFenceBlock extends ElderScrollsModModElements.ModElement {
	@ObjectHolder("elder_scrolls_mod:altmeri_wood_fence")
	public static final Block block = null;

	public Altmeri_WoodFenceBlock(ElderScrollsModModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("altmeri_wood_fence");
		}
